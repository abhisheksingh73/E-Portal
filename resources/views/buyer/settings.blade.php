        ...
        <div class="card" style="border: none; box-shadow: 0 10px 30px rgba(0,0,0,0.05); padding: 32px;">
            ...
            <form style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                <div style="display: grid; gap: 8px;">
                    ...
                    <input type="text" value="{{ auth()->user()->name }}" style="padding: 12px 16px; border-radius: 10px; border: 1px solid #e2e8f0; outline: none; font-size: 1rem;">
                </div>
                <div style="display: grid; gap: 8px;">
                    <label style="font-size: 0.85rem; font-weight: 700; color: #64748b; text-transform: uppercase;">Email Address</label>
                    <input type="email" value="{{ auth()->user()->email }}" style="padding: 12px 16px; border-radius: 10px; border: 1px solid #e2e8f0; outline: none; font-size: 1rem;">
                </div>
                <div style="display: grid; gap: 8px; grid-column: span 2;">
                    ...
                    <textarea style="padding: 12px 16px; border-radius: 10px; border: 1px solid #e2e8f0; outline: none; font-size: 1rem; height: 100px; resize: none;"></textarea>
                </div>
